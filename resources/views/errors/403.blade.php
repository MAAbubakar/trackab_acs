...
<head>
    <meta charset="UTF-8">
    <title>Access Restricted | SPESSE-CE ABU</title>
...
<body>
    ...
    <div class="access-card">
        ...
        <h1 class="access-title">This page is not available for your role</h1>

        <div class="access-message">
            {{ $message }}
            <br>
            Your account is active, but this section is reserved for another role.
        </div>

        <div class="access-note">
            If you believe you should have access to this page, please contact the system administrator or programme support desk for role review.
        </div>
