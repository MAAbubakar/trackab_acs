...
<head>
    <meta charset="utf-8">
    <title>DLI-A.2a Verification Report</title>
    <style>
...
<body>
    ...
    <h3>Participant-Level Verification Register</h3>
    <table>
        <thead>
            <tr>
