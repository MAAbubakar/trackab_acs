...
<div class="user-form-page">
    <div class="user-form-header">
        <div>
            <h1 class="user-form-title">Edit User</h1>
            <p class="user-form-subtitle">Update account details and assigned access roles.</p>
        </div>
        ...
        <div class="user-card">
            <div class="form-grid">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $user->name) }}" class="form-control-soft" required>
                </div>

                <div>
                    <label class="form-label-strong">Email Address</label>
                    <input type="email" name="email" value="{{ old('email', $user->email) }}" class="form-control-soft" required>
                </div>

                <div>
                    <label class="form-label-strong">New Password</label>
                    <input type="password" name="password" class="form-control-soft" placeholder="Leave blank to keep current password">
                </div>

                <div>
                    <label class="form-label-strong">Confirm New Password</label>
                    <input type="password" name="password_confirmation" class="form-control-soft" placeholder="Leave blank to keep current password">
                </div>
                    ...
                    <div class="roles-panel">
                        ...
                        <div class="roles-grid">
                            ...
                            @foreach($roles as $role)
                                @php
                                    $roleHelp = $roleDescriptions[$role->name] ?? 'System role.';
                                @endphp
            ...
            <div class="password-option">
                <input
                    ...
                    value="1"
                    @checked(old('must_change_password', $user->must_change_password ?? false))
                >
                <label for="must_change_password">Force password change on next login</label>
            </div>
